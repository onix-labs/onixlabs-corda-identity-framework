...
/**
 * Represents the flow handler for published accounts.
 *
 * @param session The counter-party who is publishing the account transaction.
 * @param progressTracker The progress tracker which tracks the progress of this flow.
 */
class PublishAccountFlowHandler(
    ...
    companion object {
        @JvmStatic
        fun tracker() = ProgressTracker(ReceiveAccountTransactionStep)
    }
    ...
    /**
     * Represents the initiated flow handler for published accounts.
     *
     * @param session The counter-party who is publishing the account transaction.
     */
    @InitiatedBy(PublishAccountFlow.Initiator::class)
