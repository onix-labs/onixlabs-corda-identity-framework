...
import io.onixlabs.corda.identityframework.workflow.claims.RevokeClaimFlow.Initiator
...
class RevokeClaimFlowHandler(
    ...
    /**
     * Represents the initiated flow handler for revoking claims.
     *
     * @property session The counter-party session who is initiating the flow.
     */
    ...
    private class Handler(private val session: FlowSession) : FlowLogic<SignedTransaction>() {
        ...
        private companion object {
            object HandleRevokedClaimStep : Step("Handling claim revocation.") {
