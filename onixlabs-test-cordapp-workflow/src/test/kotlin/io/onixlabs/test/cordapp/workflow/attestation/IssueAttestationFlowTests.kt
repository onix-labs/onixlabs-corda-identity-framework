...
class IssueAttestationFlowTests : FlowTest() {
    ...
    private lateinit var attestation: Attestation<GreetingClaim>
    ...
    override fun initialize() {
        Pipeline
            ...
            .run(nodeC) {
                ...
                attestation = issuedClaim.acceptLinearState(partyC)
        ...
        listOf(nodeA, nodeB, nodeC).forEach {
            it.transaction {
                ...
                val recordedAttestation = recordedTransaction
                    .tx.outputsOfType<Attestation<GreetingClaim>>().singleOrNull()
